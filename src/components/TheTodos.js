...
function initialInput(id){
  ...
  return (
    <div>
        ...
        {todos &&
          todos.map((todo) => (
            <div key={todo.id} >
              ...
              <div className="edit-icon" onClick = {()=> initialInput(todo.id)}>
      ...
      {openEditModal && <OtherModal todoId = {currentTodoId} setOpenModal = {setEditOpenModal} todos = {task} setTodos = {setTask}
